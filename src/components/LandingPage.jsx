  ...
  return (
    <div className="landingPage">
      ...
      <div className="how">
        ...
        <p className="paragraph">
          There are several rules to help you distribute the money, this tool is
          meant to be adaptable to all of them, so you can choose the one that
          best fit your current goals
        </p>
        <p className="paragraph">
      ...
      <div className="steps">
        ...
        <p className="paragraph">
          ...
          considering the tithe) That means 50 % of your income should be spent
          in necessities, 30 % ( or 20%) on wants and 20% goes to saving ( or
          paying debt)
        </p>
        <h1 className="title">02</h1>
        <h3 className="subTitle">Add your income</h3>
        <p className="paragraph">
          Combine all the paychecks that your household receive in a month . If
          there are not fixed incomes just consider them as the minimum they
          have been on the past 6 months
        </p>
        <h1 className="title">03</h1>
        <h3 className="subTitle">Adjust the model when needed</h3>
        <p className="paragraph">
          After you add your incomes you will see that according to the choosen
          percentages you will have a budget for each category, If you already
          know is not enough you are free to redistribute the percentages
          through the categories until it does (you'll need to delete the income
          and add it again)
        </p>
        ...
        <p className="paragraph">
          ...
          expenses so the month you need to pay them you can still stick to the
          budget. If you know that there is a special occasion coming up you
          need to consider that in your budget too
        </p>
        <h1 className="title">05</h1>
        <h3 className="subTitle">Spend money using wisely</h3>
        <p className="paragraph">
          Once the model is set you need to stick to it, pay every fixed expense
          as soon as you can and check the category balance before making any
          purchase. For this balance to be useful it's important you add each
          expense ( yes, even a cofee)
        </p>
      </div>
      ...
      <div className="patience">
        ...
        <p className="paragraph">
          ...
          able to get them, but you will need to wait and practice a lot of self
          control
        </p>
        <p className="paragraph">
